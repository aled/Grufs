...
namespace Wibblr.Grufs.Cli
{
    partial class Program
    {
        ...
        static void Init(string[] args) 
        {
            ...
            var protocol = ExtractOrRead(options, "protocol", "Enter protocol", "sftp");
            ...
            {
                case "sftp":
                    SftpStorage storage = new SftpStorage(host, port, user, storagePassword);
                ...
                default:
                    Console.WriteLine("Storage type must be 'sftp'");
                    break;
            }
        }
    }
